...
function check_sketch() {
    ...
    if(timer_counter>400) {
        document.getElementsById("your_sketch").innerHTML = "Your Sketch: ";
        document.getElementsById("confidence").innerHTML = "Confidence: ";
        timer_counter = 0;
...
function gotResults(error, results) {
    ...
    document.getElementsById("your_sketch").innerHTML = "Your Sketch: "+results[0].label;
